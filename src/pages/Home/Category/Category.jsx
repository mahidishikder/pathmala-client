...
function Category() {
  return (
    <div className="max-w-7xl mx-auto my-24">
      <h1 className="text-4xl font-semibold text-center ">Explore Our Book Categories</h1>
      <p className="text-lg text-gray-600 text-center mt-8">Discover a wide range of book categories that suit your interests! Whether you're passionate about Fiction, Science & Technology, History, or Self-Help & Motivation, we have a collection of books just for you.</p>
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-8">
    ...
    <div className=" cursor-pointer border shadow-gray-300 bg-gray-50 p-4 rounded-lg shadow-lg mx-auto w-full sm:w-[300px] md:w-[350px] lg:w-[300px] h-[400px] flex pt-14 flex-col items-center">
      ...
      <p className="text-gray-600 mt-2 text-center">Journey Through Fiction</p>
