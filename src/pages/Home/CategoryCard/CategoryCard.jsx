...
<div className="max-w-7xl mx-auto mt-20 py-12 px-4 ">
      {/* 📌 ক্যাটাগরি সেকশন */}
      ...
      <h1 className="lg:text-4xl text-2xl lg:font-semibold font-bold mb-8 lg:mb-14 text-center text-gray-800  dark:text-white/90">📖 Books in {categoryName}</h1>
